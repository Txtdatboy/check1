...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(
       "𝐇𝐞𝐥𝐥𝐨 🐲\n\n◆〓◆ ❖ ➵ITS๛Pυɳҽҽƚ亗 ❖ ™ ◆〓◆\n\n❈ This Bot Created By @its_Puneet_70 . I Am A Bot For Download Links From Your **.TXT** File And Then Upload That File On Telegram So Basically If You Want To Use Me First Send Me ⟰ /Upload Command And Then Follow Few Steps..", reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✜ 𝐉𝐨𝐢𝐧 𝐔𝐩𝐃𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ✜" ,url=f"https://t.me/+Fag4jwAKNZRiNzk1") ],
                    [
                    InlineKeyboardButton("✜ ➵ITS๛Pυɳҽҽƚ亗 ✜" ,url="https://t.me/Its_Puneet_70") ],
                    [
                    InlineKeyboardButton("🦋 𝐅𝐨𝐥𝐥𝐨𝐰 𝐌𝐞 🦋" ,url="https://t.me/+j1u5Ze6BlSE0ODM1") ]                               
            ]))

@bot.on_message(filters.command(["stop"]))
async def restart_handler(_, m):
    await m.reply_text("♦ 𝖘𝖙𝖔𝖕𝖕𝖊𝖉 ♦", True)
